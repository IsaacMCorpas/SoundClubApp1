...
<section class="muro">
        <form action="" class="action" id="formulario">
            <h2><i class="fas fa-music">Inicia Sesion</i></h2>
            <label>Nombre de usuario<input type="text" placeholder="&#128272; Usuario" name="Usuario" id="usuario"></label>
            <label>Contraseña<input type="password" id="passwordsignup" minlength= "3" maxlength="12" placeholder="&#128272;Contraseña" name="passwordsignup"></label>
            <input id="btnEntrar" type="submit" value="Entrar"><a href="./registrar_usuario.html">Registrate ahora</a>
        </form>
</section>
<footer>
